...
public:
	...
	void getSensorInfo(sensor_info_t* sensor);

	bool getSICMatrix(adafruit_bno055_sicmatrix_t& sic_matrix);

	bool setSICMatrix(adafruit_bno055_sicmatrix_t& sic_matrix);
