...
/*!
 *  @brief  Provides the sensor_info_t data for this sensor
 *  @param  sensor
 */
void Adafruit_BNO055::getSensorInfo(sensor_info_t* sensor) {
	/* Clear the sensor_t object */
	memset(sensor, 0, sizeof(sensor_info_t));
...
bool Adafruit_BNO055::getSICMatrix(adafruit_bno055_sicmatrix_t& sic_matrix) {
	sic_matrix.sic00 = (read8(BNO055_SIC_MATRIX_0_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_0_LSB_ADDR));
	sic_matrix.sic10 = (read8(BNO055_SIC_MATRIX_1_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_1_LSB_ADDR));
	sic_matrix.sic20 = (read8(BNO055_SIC_MATRIX_2_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_2_LSB_ADDR));

	sic_matrix.sic01 = (read8(BNO055_SIC_MATRIX_3_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_3_LSB_ADDR));
	sic_matrix.sic11 = (read8(BNO055_SIC_MATRIX_4_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_4_LSB_ADDR));
	sic_matrix.sic21 = (read8(BNO055_SIC_MATRIX_5_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_5_LSB_ADDR));

	sic_matrix.sic02 = (read8(BNO055_SIC_MATRIX_6_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_6_LSB_ADDR));
	sic_matrix.sic12 = (read8(BNO055_SIC_MATRIX_7_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_7_LSB_ADDR));
	sic_matrix.sic22 = (read8(BNO055_SIC_MATRIX_8_MSB_ADDR) << 8) |
		(read8(BNO055_SIC_MATRIX_8_LSB_ADDR));

	return true;
}

bool Adafruit_BNO055::setSICMatrix(adafruit_bno055_sicmatrix_t& sic_matrix) {

	write8(BNO055_SIC_MATRIX_0_LSB_ADDR, (sic_matrix.sic00) & 0x0FF);
	write8(BNO055_SIC_MATRIX_0_MSB_ADDR, (sic_matrix.sic00 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_1_LSB_ADDR, (sic_matrix.sic10) & 0x0FF);
	write8(BNO055_SIC_MATRIX_1_MSB_ADDR, (sic_matrix.sic10 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_2_LSB_ADDR, (sic_matrix.sic20) & 0x0FF);
	write8(BNO055_SIC_MATRIX_2_MSB_ADDR, (sic_matrix.sic20 >> 8) & 0x0FF);
	
	write8(BNO055_SIC_MATRIX_3_LSB_ADDR, (sic_matrix.sic01) & 0x0FF);
	write8(BNO055_SIC_MATRIX_3_MSB_ADDR, (sic_matrix.sic01 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_4_LSB_ADDR, (sic_matrix.sic11) & 0x0FF);
	write8(BNO055_SIC_MATRIX_4_MSB_ADDR, (sic_matrix.sic11 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_5_LSB_ADDR, (sic_matrix.sic21) & 0x0FF);
	write8(BNO055_SIC_MATRIX_5_MSB_ADDR, (sic_matrix.sic21 >> 8) & 0x0FF);

	write8(BNO055_SIC_MATRIX_6_LSB_ADDR, (sic_matrix.sic02) & 0x0FF);
	write8(BNO055_SIC_MATRIX_6_MSB_ADDR, (sic_matrix.sic02 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_7_LSB_ADDR, (sic_matrix.sic12) & 0x0FF);
	write8(BNO055_SIC_MATRIX_7_MSB_ADDR, (sic_matrix.sic12 >> 8) & 0x0FF);
	write8(BNO055_SIC_MATRIX_8_LSB_ADDR, (sic_matrix.sic22) & 0x0FF);
	write8(BNO055_SIC_MATRIX_8_MSB_ADDR, (sic_matrix.sic22 >> 8) & 0x0FF);
